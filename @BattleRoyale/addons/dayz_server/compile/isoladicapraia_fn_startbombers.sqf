...
private ["_spawnMarker","_spawnRadius","_espl","_sound","_duration","_rndSel","_loc","_city","_z","_xx","_y","_coords","_repeat","_break","_choice","_rmodyn","_preWaypoints","_sounddist","_ray","_esp2","_useRandChoice","_useRandBomb","_spawnynAI","_spawnnumAI","_numbeofBombs","_esp3","_posEsp3","_debugPosEs1","_randomLyn","_debugYn","_bombzone","_time","_finish_time_minutes","_finish_time_seconds"];
    ...
    if ((_finish_time_minutes == 80) && (_finish_time_seconds < 50))	then {
        ...
        While {_repeat > 0} do {
            ...
            While {_duration > 0} do {
				...
				_sound setPos [getPos _sound select 0, getPos _sound select 1, 40];
                sleep 2;
                If (_choice == 0) then {
