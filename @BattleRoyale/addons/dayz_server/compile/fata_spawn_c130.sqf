...
while {true} do {
	...
	_heliStart = [[100.7007,100.05298,300],[1000.715,10000.18848,300]] call BIS_fnc_selectRandom;
	...
	if (_spawnRoll <= _spawnChance) then {
		...
		*/
		...
		for "_x" from 1 to _preWaypoints do {
			...
			_preWaypointPos = [getMarkerPos "center",random 3500,random 360,false] call SHK_pos;
