	...
	if (_spawnRoll <= _spawnChance) then {
		...
		*/
		...
		for "_x" from 1 to _preWaypoints do {
			...
			_preWaypointPosPrimary = [[3234.7434, 3450.3105],
		[4630.2397, 2350.418],
[5949.0107, 3879.3403],
[4799.5405, 3968.4907],
[4198.0742, 4998.1733],
...
[5450.0127, 3429.1394],
[3948.5742, 4160.1699],
[5182.6943, 4859.9976]] call BIS_fnc_selectRandom;
			_preWaypointPos = [_preWaypointPosPrimary,random 1000,random 360,false] call SHK_pos;
