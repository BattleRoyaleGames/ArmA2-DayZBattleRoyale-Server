...
while {ELAPSED_TIME < END_TIME} do	{
    ...
    if((_finish_time_minutes == 60) && (_finish_time_seconds < 59)) then
    
    {
        [nil,nil,rTitleText,"IN 10 MINUTES, PLAY WILL BE RESTRICTED TO THE AREA INSIDE THE BLUE CIRCLE!", "PLAIN",10] call RE;
    ...
    if((_finish_time_minutes == 55) && (_finish_time_seconds < 30)) then
    ...
    if((_finish_time_minutes == 23) && (_finish_time_seconds < 59)) then
    {
    ...
    if((_finish_time_minutes == 21) && (_finish_time_seconds < 10)) then
			{                  
    ...
    if((_finish_time_minutes == 20) && (_finish_time_seconds < 10)) then {
